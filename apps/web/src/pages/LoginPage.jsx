...
const AnimatedBackgroundBlobs = () => (
  <>
    {/* --- ALTERAÇÃO AQUI: Cores um pouco mais escuras e opacidade aumentada --- */}
...
const LoginPage = () => {
  ...
  return (
    <section className="relative bg-brand-background-light w-full min-h-screen flex flex-col md:flex-row overflow-hidden">
      {/* As animações agora estão no topo e o 'overflow-hidden' no elemento pai irá contê-las */}
      ...
      {/* Lado Esquerdo - Imagem (agora com z-10) */}
      <div className="relative z-10 w-full md:w-1/2 h-64 md:h-screen hidden md:flex items-center justify-center">
        <img src={taipiriImg} alt="Portal Tapiri" className="relative z-10 max-w-[80%] h-auto" />
      </div>

      {/* Lado Direito - Formulário (agora com z-10) */}
      <div className="relative z-10 w-full md:w-1/2 flex items-center justify-center p-2 sm:p-4 md:p-6">
        <div className="w-full max-w-lg bg-white/80 backdrop-blur-sm px-6 sm:px-8 md:px-10 py-8 rounded-3xl shadow-2xl shadow-slate-400">
          <div>
