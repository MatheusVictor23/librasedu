...
import { LayoutDashboard, Users, UsersRound, BookOpen, BookCopy, Settings, Menu, LogOut, UserCircle, Building2 } from 'lucide-react';
    ...
    <>
      ...
      >
        ...
        <nav className="p-4 space-y-1 flex-grow">
          ...
          <NavLink to="/admin/disciplinas" className={({ isActive }) => `flex items-center py-2 px-3 rounded text-blue-100 ${isActive ? 'bg-brand-blue-dark font-semibold' : 'hover:bg-brand-blue-dark'}`}>
            <BookCopy size={20} className="mr-3" /> Gerir Disciplinas
          </NavLink>
